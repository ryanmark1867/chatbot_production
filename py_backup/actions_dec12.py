...
if saved_files:
   logging.warning("about to read json_dict files ")
   for file in path_dict:
      logging.warning("about to read file "+str(file))
      for cols in json_dict[file]:
         logging.warning("about to read col "+str(cols))
...
if save_files:
   logging.warning("in save_files loop ")
   ...
   for file in df_dict:
      logging.warning("in save_files loop for file"+str(file))
...
logging.warning("start of main block ")
df_dict = create_crew_by_job_dfs(df_dict['credits_crew'],df_dict)
logging.warning("past create crew ")
movie_schema = load_schema_dict(df_dict)
logging.warning("past load_schema_dict ")
